...
public class Plugin extends JavaPlugin {
    ...
    public final void onEnable() {
        try {
            ...
            if (!MythofyCommands.getInstance().isEnabled()) return;
            // Get plugin info
            ...
            onPluginEnable();
            // Log enabled
            MythofyCommands.logMessage(getInfo().name(), ChatColor.DARK_GREEN + "Plugin Enabled");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public final void onDisable() {
        ...
        MythofyCommands.logMessage(getInfo().name(), ChatColor.DARK_RED + "Plugin Disabled");
    }
    ...
    protected void onPluginEnable() throws Exception {
        MythofyCommands.logMessage(getInfo().name(), ChatColor.RED + "Did not run any code on enable!");
    }
